...
namespace mastdetail.Services
{
    public class WebService
    {
        ...
        // データを取得するメソッド
        public async Task<ObservableCollection<AEDModel>> AsyncGetWebAPIData()
        {
            ...
            var responseModels = JsonConvert.DeserializeObject<ObservableCollection<AEDModel>>(responseText);
